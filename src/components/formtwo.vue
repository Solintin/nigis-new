  ...
  <div>
    ...
    >
      <div class="text-sm sm:text-lg space-y-3 sm:space-y-7">
        ...
        <!---->
        <p class="font-semibold capitalize pb-4">
          If the land is required for the purpose of;
        </p>
        <div class="space-y-8 sm:space-y-12">
          <div class="space-y-3">
            <label class="container sm:text-lg text-sm mr-6 uppercase">
              ...
              <input
                ...
                @change="handleUpdate(isIndustry, $event)"
                :checked="isIndustry"
                v-model="isIndustry"
              />
              <span class="checkmark"></span>
            ...
            <div class="pdf" :class="isIndustry ? 'block' : 'hidden'">
              <div class="form-group space-y-3">
                <label
                ...
                >
                <input
                  @change="handleFilesUpdate(devProposal, $event)"
                  class="block form__input"
                  type="file"
                  name=""
                />
          ...
          <div>
            <label class="container sm:text-lg text-sm mr-6 uppercase">
              ...
              <input
                type="checkbox"
                @change="handleUpdate(isCommercial, $event)"
          ...
          <div class="space-y-3">
            <label class="container sm:text-lg text-sm mr-6 uppercase">
              ...
              <input
                type="checkbox"
                @click="toggleEstate"
                @change="handleUpdate(isEstate, $event)"
                :checked="isEstate"
                v-model="isEstate"
              />
              <span class="checkmark"></span>
            ...
            <div class="pdf" :class="isEstate ? 'block' : 'hidden'">
              <div class="form-group space-y-3">
                <label
                  class="block form__label font-thin text-sm sm:text-lg text-zinc-800"
                  for=""
                  ><b>Submit development proposals</b></label
                >
                <input
                  @change="handleFilesUpdate(estProposal, $event)"
                  class="block form__input"
                  type="file"
                  name=""
                />
